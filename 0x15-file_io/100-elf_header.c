...
/**
 * check_elf - function thaat checks if a file is an ELF file.
...
/**
 * print_magic - function tht prints the magic numbers of an ELF header.
 * @e_ident: A pointer to an array containing the ELF magic numbers.
 *
...
/**
 * print_type - Function tht prints the type of an ELF header.
 * @e_type: The type ELF
 * @e_ident: A pointer to an array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
 ...
 * Description: the exit code is 98 if file does not close.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * @argc: The supplied arguments to the program.
 * @argv: An array of pointers to the arguments.
 *
 * Return: 0 on success.
 *
 * Description: 98 - exit code if the file is not ELF
 */
